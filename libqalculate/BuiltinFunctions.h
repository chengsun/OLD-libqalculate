...
DECLARE_BUILTIN_FUNCTION(BitAndFunction);
DECLARE_BUILTIN_FUNCTION(BitOrFunction);
DECLARE_BUILTIN_FUNCTION(BitXorFunction);
DECLARE_BUILTIN_FUNCTION(BitNotFunction);
DECLARE_BUILTIN_FUNCTION(BitEqvFunction);
